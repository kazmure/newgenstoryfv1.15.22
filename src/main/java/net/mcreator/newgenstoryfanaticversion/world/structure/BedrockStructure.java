...
package net.mcreator.newgenstoryfanaticversion.world.structure;
...
public class BedrockStructure extends NewgenstoryFanaticVersionModElements.ModElement {
	...
	public BedrockStructure(NewgenstoryFanaticVersionModElements instance) {
		super(instance, 42);
	...
	public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
		event.getRegistry().register(feature.setRegistryName("bedrock"));
	}
