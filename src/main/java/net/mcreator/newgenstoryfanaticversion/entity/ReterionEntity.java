...
import net.mcreator.newgenstoryfanaticversion.entity.renderer.ReterionRenderer;
...
public class ReterionEntity extends NewgenstoryFanaticVersionModElements.ModElement {
	...
	public ReterionEntity(NewgenstoryFanaticVersionModElements instance) {
		super(instance, 29);
		FMLJavaModLoadingContext.get().getModEventBus().register(new ReterionRenderer.ModelRegisterHandler());
