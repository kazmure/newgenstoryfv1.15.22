...
import net.mcreator.newgenstoryfanaticversion.procedures.LeftarionStartRightClickedOnEntityProcedure;
...
public class LeftarionStartEntity extends NewgenstoryFanaticVersionModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(7f, 2f)).build("leftarion_start").setRegistryName("leftarion_start");
	public LeftarionStartEntity(NewgenstoryFanaticVersionModElements instance) {
		super(instance, 24);
		...
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new Modelenderdragon(), 2f) {
				...
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("newgenstory_fanatic_version:textures/enderdragon.png");
				}
			};
		});
	}
	public static class CustomEntity extends CreatureEntity {
		...
		public boolean processInteract(PlayerEntity sourceentity, Hand hand) {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				LeftarionStartRightClickedOnEntityProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
