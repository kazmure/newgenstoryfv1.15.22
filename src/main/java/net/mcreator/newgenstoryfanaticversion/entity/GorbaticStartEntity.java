...
import net.mcreator.newgenstoryfanaticversion.entity.renderer.GorbaticStartRenderer;
...
public class GorbaticStartEntity extends NewgenstoryFanaticVersionModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(0.6f, 1.8f)).build("gorbatic_start").setRegistryName("gorbatic_start");

	public GorbaticStartEntity(NewgenstoryFanaticVersionModElements instance) {
		super(instance, 1);
		FMLJavaModLoadingContext.get().getModEventBus().register(new GorbaticStartRenderer.ModelRegisterHandler());
