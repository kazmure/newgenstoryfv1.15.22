...
import net.mcreator.newgenstoryfanaticversion.entity.VillagerNEntity;

@OnlyIn(Dist.CLIENT)
public class VillagerNRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(VillagerNEntity.entity,
