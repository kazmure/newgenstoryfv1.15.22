...
@OnlyIn(Dist.CLIENT)
public class GorbaticStartRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(GorbaticStartEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelsteve(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("newgenstory_fanatic_version:textures/gorbatik.png");
					}
				};
			});
		}
