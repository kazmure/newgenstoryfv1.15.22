...
import net.mcreator.newgenstoryfanaticversion.procedures.Reiterion21RightClickedOnEntityProcedure;
...
public class Reiterion21Entity extends NewgenstoryFanaticVersionModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(2f, 2f)).build("reiterion_21").setRegistryName("reiterion_21");
	public Reiterion21Entity(NewgenstoryFanaticVersionModElements instance) {
		super(instance, 39);
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("reiterion_21_spawn_egg"));
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new Modelreiterion21(), 2f) {
				@Override
	...
	public static class CustomEntity extends CreatureEntity {
		...
		public boolean processInteract(PlayerEntity sourceentity, Hand hand) {
			...
			Entity entity = this;
			{
				...
				Reiterion21RightClickedOnEntityProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
		...
		protected void registerAttributes() {
			...
			this.getAttribute(SharedMonsterAttributes.ATTACK_KNOCKBACK).setBaseValue(1000D);
	...
	public static class Modelreiterion21 extends EntityModel<Entity> {
		...
		public Modelreiterion21() {
			...
			setRotationAngle(rearleg, 1.1254F, -0.6925F, 0.4995F);
			...
			setRotationAngle(rearleg1, 1.3932F, 0.5198F, -0.3368F);
			...
			setRotationAngle(frontleg, 1.5333F, -0.5467F, 0.2877F);
			...
			setRotationAngle(frontleg1, 1.4118F, 0.8367F, -0.543F);
