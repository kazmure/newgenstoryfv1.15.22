...
import net.mcreator.newgenstoryfanaticversion.entity.renderer.LeftarionRenderer;
...
public class LeftarionEntity extends NewgenstoryFanaticVersionModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(7f, 2f)).build("leftarion").setRegistryName("leftarion");

	public LeftarionEntity(NewgenstoryFanaticVersionModElements instance) {
		super(instance, 2);
		FMLJavaModLoadingContext.get().getModEventBus().register(new LeftarionRenderer.ModelRegisterHandler());
