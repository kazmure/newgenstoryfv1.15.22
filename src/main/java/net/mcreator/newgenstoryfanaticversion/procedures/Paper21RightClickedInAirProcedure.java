...
public class Paper21RightClickedInAirProcedure extends NewgenstoryFanaticVersionModElements.ModElement {
	public Paper21RightClickedInAirProcedure(NewgenstoryFanaticVersionModElements instance) {
		super(instance, 21);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				NewgenstoryFanaticVersionMod.LOGGER.warn("Failed to load dependency entity for procedure Paper21RightClickedInAir!");
			return;
		}
