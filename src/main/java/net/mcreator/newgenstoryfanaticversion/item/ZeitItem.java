...
public class ZeitItem extends NewgenstoryFanaticVersionModElements.ModElement {
	@ObjectHolder("newgenstory_fanatic_version:zeit_helmet")
	public static final Item helmet = null;
	@ObjectHolder("newgenstory_fanatic_version:zeit_chestplate")
	public static final Item body = null;
	@ObjectHolder("newgenstory_fanatic_version:zeit_leggings")
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(NewGenStoryItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "newgenstory_fanatic_version:textures/models/armor/diamond_1_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("zeit_helmet"));
