...
public static class Modelvillager_v2<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = body.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F,
				-10.0F, -4.0F, 8.0F, 11.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -24.0F, 0.0F));
		...
		PartDefinition brim = head
				.addOrReplaceChild("brim",
						CubeListBuilder.create().texOffs(30, 47).addBox(-6.0F, -6.0F, -5.0F, 12.0F, 12.0F, 0.0F,
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(44, 13)
						...
						.addBox(-6.0F, -19.0F, -3.0F, 1.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));
